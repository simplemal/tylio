...
return [
    ...
    'public.maintenance_banner.title' => 'Site under maintenance',
    'public.maintenance_banner.body' => 'Visitors see the maintenance page. You — logged in — see the site normally so you can test it.',
    'public.maintenance_banner.action' => 'Manage',
    ...
    'blocks.hero.fields.align.help' => 'Position of the block (avatar + text) on the desktop row. The inner layout always stays avatar-left + title/subtitle-right; only the whole pair is anchored to the left of the tile or centered. Mobile is always centered.',
    ...
    'blocks.links.fields.items.of.icon_mode.label' => 'Icon',
    'blocks.links.fields.items.of.icon_mode.options.favicon.label' => 'Use the site favicon',
    'blocks.links.fields.items.of.icon_mode.options.favicon.description' => 'Automatically loads the icon of the linked domain (default).',
    'blocks.links.fields.items.of.icon_mode.options.custom.label' => 'Use a custom icon',
    'blocks.links.fields.items.of.icon_mode.options.custom.description' => 'Pick an Iconify icon from the library.',
    'blocks.links.fields.items.of.icon.label' => 'Custom icon',
    'blocks.links.fields.items.of.icon.help' => 'Iconify name, e.g. lucide:globe',
    'blocks.links.fields.items.of.badge.label' => 'Badge',
    'blocks.links.fields.items.of.badge.placeholder' => 'E.g. "new"',
